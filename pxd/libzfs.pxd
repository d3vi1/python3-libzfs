...
cdef extern from "libzfs.h" nogil:
    ...
    ctypedef int (*zpool_iter_f)(zpool_handle_t *, void *) nogil
    ...
    ctypedef int (*zfs_iter_f)(zfs_handle_t *, void *) nogil
    ...
    ctypedef int (*snapfilter_cb_t)(zfs_handle_t *, void *) nogil
